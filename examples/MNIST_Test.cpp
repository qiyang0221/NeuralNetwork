...
#include <fstream>
#include <string>
#include "../include/chai.h"

unsigned int MaxElement(std::vector<float> input);
std::vector<std::vector<float> > LoadMNIST(std::string);
...
std::vector<std::vector<float> > LoadMNIST(std::string data_dir)
{
  //open the MNIST dataset
  std::ifstream data0;
  data0.open(data_dir + "/data0.txt", std::ios::binary);
  std::ifstream data1;
  data1.open(data_dir + "/data1.txt", std::ios::binary);
  std::ifstream data2;
  data2.open(data_dir + "/data2.txt", std::ios::binary);
  std::ifstream data3;
  data3.open(data_dir + "/data3.txt", std::ios::binary);
  std::ifstream data4;
  data4.open(data_dir + "/data4.txt", std::ios::binary);
  std::ifstream data5;
  data5.open(data_dir + "/data5.txt", std::ios::binary);
  std::ifstream data6;
  data6.open(data_dir + "/data6.txt", std::ios::binary);
  std::ifstream data7;
  data7.open(data_dir + "/data7.txt", std::ios::binary);
  std::ifstream data8;
  data8.open(data_dir + "/data8.txt", std::ios::binary);
  std::ifstream data9;
  data9.open(data_dir + "/data9.txt", std::ios::binary);
...
int main(int argc, char* argv[])
{
    ...
    srand(time(NULL));
    std::vector<std::vector<float> > training_data = LoadMNIST(data_dir);
